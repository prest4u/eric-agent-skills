...
ENV_NAMES = (
    ...
    "ELEVENLABS_TTS_PROFILE",
    "ELEVENLABS_TTS_SETTINGS_JSON",
...
def load_env() -> dict[str, str]:
    """Read only the environment keys this tool explicitly supports."""
    values: dict[str, str] = {}
...
def main() -> int:
    ...
    if not api_key:
        raise ElevenLabsError("Missing ELEVENLABS_API_KEY in the process environment.")
    ...
    voice_id_from_env = os.environ.get(str(voice_id_env_name)) if voice_id_env_name else None
