...
// Keep geometry shared with Eric Slate White PDF; change theme tokens only.

#let document-title = __DOCUMENT_TITLE_JSON__
#let document-subtitle = __DOCUMENT_SUBTITLE_JSON__

#let paper = rgb("#F6F3EA")
#let ink = rgb("#252824")
#let muted = rgb("#747568")
#let micro = rgb("#646659")
#let hair = rgb("#D3D2C6")
#let primary = rgb("#626A56")
#let secondary = rgb("#5D6C75")
...
#set document(
  ...
  author: "",
  keywords: ("Eric Moss Ivory PDF", "苔绿象牙", "editorial"),
)
...
#v(15mm)
#eyebrow([ERIC MOSS IVORY PDF · EDITORIAL SYSTEM])
#v(22mm)
#grid(
  columns: (16mm, 1fr),
  gutter: 10mm,
  [
    #text(font: latin, size: 9pt, weight: "semibold", fill: primary)[MI]
    #v(6mm)
...
#grid(
  ...
  [
    #label([MOSS · PRIMARY])
    #v(3mm)
    #quiet([中文结构、章节骨架与关键引文。])
  ],
  [
    #label([SLATE · SECONDARY], tone: secondary)
    #v(3mm)
    #quiet([英文眉题、分析提示与次级信息。])
  ],
)
