---
name: dsl-vm-reverse
description: "Use when Eric asks to understand or recover a JavaScript-hosted custom DSL/VM, non-standard WASM-like runtime, or risk-control engine. Start with the smallest observable dispatcher and state model, then recover opcode semantics, bytecode flow, or runtime evidence only as far as the requested result requires."
---
