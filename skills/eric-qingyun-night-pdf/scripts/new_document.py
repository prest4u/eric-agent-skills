#!/usr/bin/env python3
"""Scaffold a 青云 night-chassis Typst project. This skin slice is subject-only."""
...
def main() -> int:
    ...
    parser.add_argument("--title", default="选科指导报告")
    ...
    parser.add_argument("--batch", default="高一选科")
    parser.add_argument("--version", default="V1")
    parser.add_argument("--date", default="2026-08-19")
    args = parser.parse_args()

    if args.scene != "subject":
        raise SystemExit(
            "This skin slice is subject-only. "
            f"Refusing scene={args.scene!r}."
        )
    ...
    theme = skill_root / "theme.typ"
    skeleton = skill_root / "assets" / "skeletons" / "subject.typ"
