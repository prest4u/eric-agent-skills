...
Available grammars include typography-led, photography-led, object/section annotation, archival collage, data field, spatial map, and relationship diagram. These are angles for thinking, not templates that must be applied.
